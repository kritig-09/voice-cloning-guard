...
r_html("<div class='vcg-footer'>VoiceCloneGuard is a Smart India Hackathon prototype. It provides acoustic evidence and a risk-oriented response; it does not prove speaker identity. The 61.8% figure is a local 34-file prototype evaluation and is not a production benchmark.</div>")
